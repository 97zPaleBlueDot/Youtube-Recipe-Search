...
class YoutubeCrawler:
    ...
    def get_menu_id_and_name_list(self, cursor):
        try:
            ...
            cursor.execute(
                "SELECT id, name FROM menu ORDER BY 1 LIMIT 808"
            )  # 상위 808개의 레시피 추출.
    ...
    def search_menu_name(self, menu_name):
        try:
            ...
            request = self.youtube.search().list(
                part="id", maxResults=10, q=menu_name + " 레시피"
            )
    ...
    def get_video_infos(self, video_url):
        try:
            ...
            thumbnail_element = self.driver.find_element(
                By.XPATH, "/html/body/div[1]/link[2]"
            )
            ...
            channel_img_element = self.driver.find_element(
                By.XPATH,
            ...
            channel_name_element = self.driver.find_element(
                By.XPATH,
            ...
            channel_subscribers_count_element = self.driver.find_element(
                By.XPATH,
            ...
            thumbsup_count_element = self.driver.find_element(
                By.XPATH,
                "/html/body/ytd-app/div[1]/ytd-page-manager/ytd-watch-flexy/div[5]/div[1]/div/div[2]/ytd-watch-metadata/div/div[2]/div[2]/div/div/ytd-menu-renderer/div[1]/segmented-like-dislike-button-view-model/yt-smartimation/div/div/like-button-view-model/toggle-button-view-model/button-view-model/button/div[2]",
            )
            thumbsup_count = thumbsup_count_element.text

            views_count_element = self.driver.find_element(
                By.XPATH,
            ...
            uploaded_date_element = self.driver.find_element(
                By.XPATH,
            ...
            video_text_element = self.driver.find_element(
                By.XPATH,
